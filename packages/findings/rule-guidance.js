...
const RULE_GUIDANCE = {
  ...
  'seo.canonical-cross-host': 'Confirm the cross-host canonical is deliberate — it hands ranking to another host.',
  ...
  'seo.hreflang-duplicate-target': 'Give each language variant its own URL — search engines expect distinct targets.',
