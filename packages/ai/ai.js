...
export async function frankWalkthrough(graph){
  ...
  if(!validateFrankPlan(candidate,graph))throw runtimeError('AI_INVALID_PLAN','The generated walkthrough failed validation.');
  return candidate;
}
